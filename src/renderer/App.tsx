  ...
  return <div className="app-shell">
    ...
    <main className="workspace">
      ...
      <div className="page-scroll">
        ...
        {view === 'recommendations' ? <RecommendedPacksPage profile={mosaic.currentProfile} feed={mosaic.activeRecommendationFeed} history={mosaic.recommendationHistory} loading={mosaic.loadingRecommendations} loadingId={mosaic.loadingRecommendationId} onLoad={(scope, force) => void mosaic.loadRecommendations(scope, force)} onSelectFeed={mosaic.setActiveRecommendationFeedId} onPreview={(id) => void mosaic.previewRecommendation(id)}/> : null}
