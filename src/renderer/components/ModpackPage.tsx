...
export function ModpackPage({ profile, classifyingMods, onDiscover, onEdit, onDuplicate, onOrganize, onRemove, onExport, onExportModList, onDeleteProfile }: {
  ...
  return <ModpackContent profile={profile} classifyingMods={classifyingMods} onDiscover={onDiscover} onEdit={onEdit} onDuplicate={onDuplicate} onOrganize={onOrganize} onRemove={onRemove} onExport={onExport} onExportModList={onExportModList} onDeleteProfile={onDeleteProfile}/>;
}

function ModpackContent({ profile, classifyingMods, onDiscover, onEdit, onDuplicate, onOrganize, onRemove, onExport, onExportModList, onDeleteProfile }: {
  profile: ModpackProfile;
  classifyingMods: boolean;
  onDiscover: () => void;
  onEdit: () => void;
